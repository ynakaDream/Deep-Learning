...
def convert_into_batch(batch_size, is_download=False):
    ...
    train_set = STL10(root='./dataset', split='train', download=is_download, transform=transform)
    test_set = STL10(root='./dataset', split='test', download=is_download, transform=transform)

    train_batches = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=2)
    test_batches = DataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=2)
